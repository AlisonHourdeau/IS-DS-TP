...
ACP on prend en compte la variance totale.
...
Réalisation de l'AFD avec Prend en  compte la variance intra classe et inter classe
...
question 20
AFD on peut comparer les valeurs propres sur deux AFD différentes et donc comparer les composantes.
Le premier vecteur propre de W-1*B est -1 le vecteur propre de V-1*B.

La valeur propre est une distance de Mahalanobis.


Résoudre W-1*B et V-1*B c'est la même chose. On a les mêmes valeurs propres et des vecteurs propres inversés.


question 21
ACP a besoin des deux composantes pour définir ces classes.
AFD seulement une composante arriverait à définir les classes.
AFD a réussi avec une seule composante canonique à discriminer les classes.
...
2. diagnostique sur un échantillon test
