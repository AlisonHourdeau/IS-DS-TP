...
{lettre}            {
                     yylval.nomEns = yytext[0];  /* Affectation a yylval du nom de l'ensemble reconnu */
                     return LETTRE;     /* Indique au parser qu une lettre est reconnu */
                    }
{chiffre}+          {
                     yylval.valEnt = atoi(yytext);  /* Affectation a yylval de la valeur de l'Entier reconnu */
                     return ENTIER;     /* Indique au parser qu un entier est reconnu */
                    }
